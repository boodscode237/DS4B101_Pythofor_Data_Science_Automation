...
getcwd()
# bikes_df = pd.read_excel(f'{getcwd()}/00_data_raw/bikes.xlsx')
bikes_df = pd.read_excel('.bikes.xlsx')
bikes_shops_df = pd.read_excel(f'{getcwd()}/00_data_raw/bikeshops.xlsx')
orderlines_df = pd.read_excel(
    io=f'{getcwd()}/00_data_raw/orderlines.xlsx',
